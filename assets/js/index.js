...
function adicionaDadosAluno() {
    ...
    const media1 = ((parseFloat(prova1)) + (parseFloat(aep1)) + (parseFloat(integrada1))).toFixed(2);
    const media2 = ((parseFloat(prova2)) + (parseFloat(aep2)) + (parseFloat(integrada2))).toFixed(2);
